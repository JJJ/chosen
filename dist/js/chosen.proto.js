(function() {
  ...
  AbstractChosen = (function() {
    class AbstractChosen {
      ...
      get_single_html() {
        return `<a class="chosen-single chosen-default" role="button" tabindex="0" aria-haspopup="listbox" aria-expanded="false">
  ...
  this.Chosen = (function() {
    ...
    class Chosen extends AbstractChosen {
      ...
      set_default_values() {
        ...
        // HTML Templates
        this.single_temp = new Template('<a class="chosen-single chosen-default" role="button" tabindex="0" aria-haspopup="listbox" aria-expanded="false"> <span>#{default}</span> <div> <b aria-hidden="true"></b> </div> </a> <div class="chosen-drop"> <div class="chosen-search"> <input aria-autocomplete="list" aria-expanded="false" aria-haspopup="listbox" autocomplete="off" class="chosen-search-input" role="combobox" type="text" /> </div> <ul aria-busy="true" class="chosen-results" role="listbox" > </ul> </div>');
      ...
      register_observers() {
        ...
        if (this.is_multiple) {
          ...
          this.container.observe("click", (evt) => {
            return evt.preventDefault(); // gobble click of anchor
          });
          return this.selected_item.observe("keydown", (evt) => {
            var ref;
            if (((ref = evt.keyCode) === 13 || ref === 32) && !this.is_disabled) {
              evt.preventDefault();
      ...
      set_aria_labels() {
        ...
        if (this.form_field.attributes["aria-label"]) {
          this.search_field.writeAttribute("aria-label", this.form_field.readAttribute("aria-label"));
        }
        if (this.form_field.attributes["aria-labelledby"]) {
          this.search_field.writeAttribute("aria-labelledby", this.form_field.readAttribute("aria-labelledby"));
        } else if (!this.form_field.attributes["aria-label"] && Object.prototype.hasOwnProperty.call(this.form_field, 'labels') && this.form_field.labels.length) {
          labelledbyList = "";
          ...
          this.search_field.writeAttribute("aria-labelledby", labelledbyList);
        }
        if (this.form_field.attributes["aria-describedby"]) {
          return this.search_field.writeAttribute("aria-describedby", this.form_field.readAttribute("aria-describedby"));
        }
      }
      ...
      search_field_disabled() {
        ...
        if (!this.is_multiple) {
          ...
          this.selected_item.writeAttribute('aria-disabled', String(this.is_disabled));
          this.selected_item.writeAttribute('tabindex', this.is_disabled ? -1 : 0);
        }
        if (this.is_disabled) {
      ...
      results_show() {
        ...
        if (!this.is_multiple) {
          this.selected_item.writeAttribute("aria-expanded", "true");
        }
      ...
      results_hide() {
        if (this.results_showing) {
          ...
          this.container.removeClassName("chosen-dropup");
          if (!this.is_multiple) {
            this.selected_item.writeAttribute("aria-expanded", "false");
          }
