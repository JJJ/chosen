  ...
  this.Chosen = (function() {
    ...
    class Chosen extends AbstractChosen {
      ...
      set_default_values() {
        ...
        // HTML Templates
        this.single_temp = new Template('<a class="chosen-single chosen-default" role="button"> <span>#{default}</span> <div> <b aria-hidden="true"> <button type="button" class="chosen-single-button" aria-label="Show options" tabindex="-1"></button> </b> </div> </a> <div class="chosen-drop"> <div class="chosen-search"> <input aria-autocomplete="list" aria-expanded="false" aria-haspopup="listbox" autocomplete="off" class="chosen-search-input" role="combobox" type="text" /> </div> <ul aria-busy="true" class="chosen-results" role="listbox" > </ul> </div>');
