...
"""
  ...
  grunt.registerTask 'test',  ['build', 'coffee:test', 'jasmine:jquery', 'jasmine:jquery_old', 'jasmine:proto']
  grunt.registerTask 'test:jquery',  ['build', 'coffee:test', 'jasmine:jquery', 'jasmine:jquery_old']
  grunt.registerTask 'test:proto',  ['build', 'coffee:test', 'jasmine:proto']
