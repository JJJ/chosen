  ...
  AbstractChosen = (function() {
    class AbstractChosen {
      ...
      winnow_results(options) {
        var escaped_query, exact_regex, exact_result, fix, highlight_regex, i, j, k, l, len, match_length, match_value, matched_length_in_normalized, normalized_query, normalized_terms, normalized_text, option, prefix, prefix_normalized, query, ref, ref1, ref2, ref3, regex, results, results_group, search_match, search_matches, startpos, substr_normalized, suffix, term, term_regex, term_regexes, text, value_matches;
